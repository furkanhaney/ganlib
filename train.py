...
def main():
    ...
    parser.add_argument("--network_width", help="Scale up the number of units in each layer", type=int, default=1)
    ...
    gen = Generator(noise_dim=args.noise_dim, bn=args.gen_batch_norm, dropout=args.gen_dropout, width=args.network_width)
    disc = Discriminator(bn=args.disc_batch_norm, dropout=args.disc_dropout, width=args.network_width)
    print(gen)
    print(disc)
